...
pub(crate) fn symbol_id_for_kind(kind: ComponentKind) -> &'static str {
    match kind {
        ...
        ComponentKind::Stm32BluePill => "MCU:STM32_BluePill_F103C8",
        ComponentKind::Stm32Nucleo64 => "MCU:STM32_Nucleo_64",
...
pub(crate) fn default_footprint_for_kind(kind: ComponentKind) -> Option<&'static str> {
    match kind {
        ...
        ComponentKind::Stm32BluePill => Some("Module_STM32_BluePill"),
        ComponentKind::Stm32Nucleo64 => Some("Module_STM32_Nucleo_64"),
